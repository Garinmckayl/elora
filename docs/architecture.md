...
```
Phone (Expo)  ──────── WebSocket ──────────  Cloud Run (FastAPI + ADK)
                                                       │
                         ┌─────────────────────────────┘
                         │
              ┌──────────▼──────────────────────────────────┐
              │            Agent Hierarchy                   │
              │                                             │
              │   elora_root  ←──── SYSTEM_INSTRUCTION       │
              │       │                                      │
              │  ┌────┼────────────────────────┐            │
              │  │    │         │              │            │
              │  ▼    ▼         ▼              ▼            │
              │ web  browser  email         file_memory     │
              │ researcher worker calendar                  │
              │  (search   (Playwright                      │
              │   + fetch)  + CU model)                     │
              │       │                                      │
              │       ▼                                      │
              ...
              │  ├── ResearchJudge (quality check)           │
              │  └── EscalationChecker (break/continue)      │
              └─────────────────────────────────────────────┘
                         │
           ┌─────────────┼─────────────┐
           ▼             ▼             ▼
